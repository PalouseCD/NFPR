...
if (MONITORING_SITE_ID == "NFPR5A"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR5A_2008-05-20_to_2023-03-06_.CSV") 
}  

if (MONITORING_SITE_ID == "NFPR6"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR6_2001-06-05_to_2023-03-06_.CSV")
}

if (MONITORING_SITE_ID == "NFPR6P"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR6P_2017-04-03_to_2022-09-12_.CSV")
}

if (MONITORING_SITE_ID == "NFPR8"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR8_2008-05-20_to_2022-09-12_.CSV")
}

if (MONITORING_SITE_ID == "NFPR8A"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR8A_2008-05-20_to_2019-06-17_.CSV")
}

if (MONITORING_SITE_ID == "NFPR9"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR9_2001-12-04_to_2023-03-06_.CSV")
}

if (MONITORING_SITE_ID == "NFPR9B"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR9B_2010-07-12_to_2019-06-17_.CSV")
}

if (MONITORING_SITE_ID == "NFPR12"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/NFPR12_2008-05-20_to_2023-03-06_.CSV")
}

if (MONITORING_SITE_ID == "PAL112.4"){
  MASTER = read.csv("R:/_04_Project_Data/R/NFPR/outputs/Individual_Sites/PAL112.4_2010-07-12_to_2022-09-12_.CSV")
}
...
### **Orthophosphate**
The figure below displays orthophosphate (OP) concentrations, in milligrams per liter (mg/L), from `r FIRST_SAMPLE` to `r LAST_SAMPLE`. In addition to the total phosphorus values displayed above, orthophosphates, the dissolved form phosphorous, can provide an estimate of how much phosphorus is available to aquatic plants. OP can also aid in the identification of pollution sources since it is commonly derived from fertilizers or other anthropogenic sources. Orthophosphate samples are collected monthly in-stream.
